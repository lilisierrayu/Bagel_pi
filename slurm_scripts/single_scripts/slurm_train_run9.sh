...
srun torchrun --nnodes=$SLURM_NNODES --nproc_per_node=8 \
  ...
  --dataset_config_file data/configs/seedp1_0.2_arx_i2_endspan.yaml \
  --wandb_name pi_arx_i2_endspan_seedp1_gpu${total_gpus}_seq${seq_len} \
  --wandb_runid 0 \
