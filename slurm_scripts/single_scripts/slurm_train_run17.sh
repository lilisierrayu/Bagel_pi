...
#SBATCH --qos=normal
#SBATCH --job-name=allview_ur5_b0
...
srun torchrun --nnodes=$SLURM_NNODES --nproc_per_node=8 \
  ...
  --dataset_config_file data/configs/seedp1_0.2_ur5e4_b0_allview_endspan.yaml  \
  --exp_name pi_ur5e4_b0_allview_seq_seedp1_gpu${total_gpus}_seq${seq_len} \
  --wandb_runid 0 \
