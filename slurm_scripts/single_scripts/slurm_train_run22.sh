...
srun torchrun --nnodes=$SLURM_NNODES --nproc_per_node=8 \
  ...
  --dataset_config_file data/configs/seedp1_0.2_statics_text_allview_endspan.yaml \
  --exp_name pi_splited_seq_text_seedp1_gpu${total_gpus}_seq${seq_len} \
  --wandb_runid 0 \ 
