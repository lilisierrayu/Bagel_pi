...
class ModelArguments:
    model_path: str = field(
        default="pretrained_models/BAGEL-small-fake",
    ...
    vae_path: str = field(
        default="pretrained_models/BAGEL-7B-MoT/ae.safetensors",
...
def main():
    ...
    if training_args.visual_gen:
        print(os.path.join(model_args.model_path, "ae.safetensors") )
